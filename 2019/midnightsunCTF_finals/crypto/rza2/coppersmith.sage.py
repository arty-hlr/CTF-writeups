...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_4 = Integer(4); _sage_const_512 = Integer(512); _sage_const_47702774091583083413514954181005338733744246354146014100833529117112767 = Integer(47702774091583083413514954181005338733744246354146014100833529117112767); _sage_const_ = Integer(); _sage_const_0p5 = RealNumber('0.5')
import time
...
# N = p*q;
a = _sage_const_47702774091583083413514954181005338733744246354146014100833529117112767 
...
# qbar = q + diff; 
qbar = isqrt(N) + diff//_sage_const_2 
...
print("in: %s seconds " % (time.time() - start_time))
if roots:
    print(qbar-roots[_sage_const_0 ])
