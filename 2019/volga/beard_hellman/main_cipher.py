...
from basis_map import bmap, invbmap
import os
...
# key = "37234b7a05c532c574359607".decode("hex")
# cipher = Cipher(key)
# ct = open("encrypted").read()
# print `cipher.decrypt(ct.decode("base64"))`
# quit()
# print cipher.encrypt("ABCDEFGHIJ").encode("hex")
...
if __name__ == '__main__':
    ...
    cipher = Cipher(key)
    ct = open("encrypted").read()
    print cipher._convert_text("\x00" * 8)
