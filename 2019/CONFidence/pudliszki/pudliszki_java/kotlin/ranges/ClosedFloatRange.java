  ...
  implements ClosedFloatingPointRange<Float>
{
  ...
  public Float getStart() { return Float.valueOf(_start); } @NotNull
  public Float getEndInclusive() { return Float.valueOf(_endInclusive); }
  
  public boolean lessThanOrEquals(float a, float b) { return a <= b; }
  
  public boolean contains(float value) { return (value >= _start) && (value <= _endInclusive); }
  public boolean isEmpty() { return _start > _endInclusive; }
  
  public boolean equals(@Nullable Object other) {
    return ((other instanceof ClosedFloatRange)) && (((isEmpty()) && (((ClosedFloatRange)other).isEmpty())) || ((_start == _start) && (_endInclusive == _endInclusive)));
  }
  


  public int hashCode() { return isEmpty() ? -1 : 31 * Float.valueOf(_start).hashCode() + Float.valueOf(_endInclusive).hashCode(); }
