...
public abstract interface CoroutineContext
{
    ...
    extends CoroutineContext
  {
    ...
    public static final class DefaultImpls
    {
      ...
      {
        Intrinsics.checkParameterIsNotNull(key, "key"); if (Intrinsics.areEqual($this.getKey(), key)) { if ($this != null) break label38; throw new TypeCastException("null cannot be cast to non-null type E");throw $this; } label38: return null;
      }
      ...
      @NotNull
      public static CoroutineContext minusKey(CoroutineContext.Element $this, @NotNull CoroutineContext.Key<?> key) { Intrinsics.checkParameterIsNotNull(key, "key");return Intrinsics.areEqual($this.getKey(), key) ? (CoroutineContext)EmptyCoroutineContext.INSTANCE : (CoroutineContext)$this;
      }
  ...
  @Metadata(mv={1, 1, 13}, bv={1, 0, 3}, k=1, d1={"\000\020\n\002\030\002\n\000\n\002\030\002\n\002\020\000\n\000\bf\030\000*\b\b\000\020\001*\0020\0022\0020\003¨\006\004"}, d2={"Lkotlin/coroutines/CoroutineContext$Key;", "E", "Lkotlin/coroutines/CoroutineContext$Element;", "", "kotlin-stdlib"})
