  ...
  implements FunctionBase<Object>, SuspendFunction
{
  ...
  public SuspendLambda(int arity, @Nullable Continuation<Object> completion) { super(completion);this.arity = arity; }
  public SuspendLambda(int arity) { this(arity, null); }
