  ...
  extends PrimitiveSpreadBuilder<short[]>
{
  ...
  protected int getSize(@NotNull short[] $receiver) { Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");return $receiver.length; }
  
  public final void add(short value) { int i;
    setPosition((i = getPosition()) + 1);values[i] = value; }
  
  @NotNull
  public final short[] toArray() { return (short[])toArray(values, new short[size()]); }
}
